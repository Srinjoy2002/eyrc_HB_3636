...
class HBTask1BController(Node):
    ...
    def __init__(self):
        ...
        self.Kp = 1.5 # p value
        self.linear_tolerance = 0.1 # linear tolerance
        self.angular_tolerance = 0.2 #math.radians(10) # degree tolerance
    ...
    def odometryCb(self, odom: Odometry):
        ...
        msg =  "cur" + str(round(self.hb_x, 2)) + "\t" + str(round(self.hb_x, 2)) + "\t" + str(round(self.hb_theta, 2))
    ...
    while rclpy.ok():
        ...
        if ebot_controller.future.done():
            try:
                ...
                msg = Twist()
                msg.linear.x = ebot_controller.Kp * (body_error_x)
                msg.linear.y = ebot_controller.Kp * (body_error_y)
                msg.angular.z = ebot_controller.Kp * (body_error_theta)
